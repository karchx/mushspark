...
object MushroomData extends App {
  val sparkSession: SparkSession = SparkSession
    ...
    .config("spark.sql.catalog.lakehouse.warehouse", "s3a://mushroom/")

    .config("spark.hadoop.fs.s3a.endpoint", "http://rustfs:9000")
    .config("spark.hadoop.fs.s3a.access.key", "Up1Q8ZGHI6VTFvRb0wXm")
    .config("spark.hadoop.fs.s3a.secret.key", "OmoD9CQTYZ80EsB6a4PJHxFwjuzqKtURyfSdg2pv")
